...
const CartMenu = ({ oepnCart, setOpenCart }) => {
    ...
    return (
        <div className={`${oepnCart ? 'right-0' : '-right-88'} duration-500 w-87.5 bg-white h-screen fixed top-0 z-30 shadow-2xl overflow-y-scroll text-black`}>
            <CartClose
            ...
            <div className='px-4 pt-5 pb-4'>
                {(!cart || cart.length === 0) ? (
                    <div className='empty-cart flex flex-col items-center justify-center'>
                        <img src="/empty-cart.png" className='mb-4' alt="" />
                                ...
                                return (
                                    <div key={item.id} className='flex items-center justify-between mb-4'>
                                        <div className='flex items-center'>
                                            <img src={item.foodImg} className='w-20 h-20 object-cover rounded-md' alt="" />
                                            <div className='ml-4'>
